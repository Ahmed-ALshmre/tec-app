...
class Coppon extends StatefulWidget {
  static String routeName = "/coppon";
  @override
  _CopponState createState() => _CopponState();
}
class _CopponState extends State<Coppon> {
  @override
  ...
  Widget _drawProducts() {
    return StreamBuilder<QuerySnapshot>(
        stream: Firestore.instance.collection('coppon').snapshots(),
