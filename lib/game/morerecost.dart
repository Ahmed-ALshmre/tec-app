...
class MoreRec extends StatefulWidget {
  static String routeName = "/allProduct";
  @override
  _MoreRecState createState() => _MoreRecState();
}
class _MoreRecState extends State<MoreRec> {
  @override
  ...
  Widget _drawProducts(bool them) {
    return StreamBuilder<QuerySnapshot>(
        stream: Firestore.instance.collection('moreRequest').snapshots(),
